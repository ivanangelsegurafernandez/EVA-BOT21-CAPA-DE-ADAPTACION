...
Generado UTC: `2026-03-06T11:36:53.757450+00:00`
Reporte ID: `459f839b3daf` (JSON/MD del mismo corte temporal)
...
| fulll50 | 35.0% | 0 | N/A | N/A | N/A | N/A | BAJA(<5) |
...
- Features activas del campeón: **6**
- Colapso (<5 features): **NO**
- reliable: **NO** | AUC: **0.7262931034482758**
- Bloquear promoción por colapso: **NO**
## 7) Salud de ejecución (auth/ws/timeout)
- Archivo auditado: `runtime_log_ia.txt` | líneas: 229547
- auth_error=0, ws_error=0, timeout=2, api_error=0
- WHY-NO más frecuentes: warmup:24423, trigger_no:23963, confirm_pending(0/1):18368, n<80:6404, n15_pending:6389, confirm_pending(0/2):6284, p_best<50.0%:6158, p_best<58.0%:5220
